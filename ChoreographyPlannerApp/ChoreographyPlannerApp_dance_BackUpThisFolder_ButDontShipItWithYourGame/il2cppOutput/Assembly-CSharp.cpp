...
IL_000e:
	...
	{
		// placed = GameObject.Instantiate(objectToPlace, transform.position, transform.rotation);
		...
		__this->___placed_6 = L_10;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___placed_6), (void*)L_10);
		// placed.GetComponent<Animator>().Play("mixamo.com");
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_11 = __this->___placed_6;
		NullCheck(L_11);
		...
		NullCheck(L_12);
		Animator_Play_m0F6A9F84B2E256E644D56C34A7A9BD622CB00FF9(L_12, _stringLiteral3AFC86962125AF42F9979B8D89F97CB397E5E63B, NULL);
		return;
	}
...
IL_0071:
	...
	{
		// placed = GameObject.Instantiate(objectToPlace, hits[0].pose.position, hits[0].pose.rotation);
		...
		__this->___placed_6 = L_30;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___placed_6), (void*)L_30);
		// placed.GetComponent<Animator>().Play("mixamo.com");
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_31 = __this->___placed_6;
		NullCheck(L_31);
		...
		NullCheck(L_32);
		Animator_Play_m0F6A9F84B2E256E644D56C34A7A9BD622CB00FF9(L_32, _stringLiteral3AFC86962125AF42F9979B8D89F97CB397E5E63B, NULL);
	}
